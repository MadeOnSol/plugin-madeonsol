...
const pctOf = (v) => (v == null ? "n/a" : `${v.toFixed(2)}%`);
...
export const tokenFeeSharesAction = {
    ...
    handler: async (runtime, message, _state, _options, callback) => {
        ...
        if (d.past_recipients?.length)
            lines.push(`• Past recipients no longer in the split: ${d.past_recipients.length}`);
