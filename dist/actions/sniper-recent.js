...
export const sniperRecentAction = {
    ...
    description: "Get the deshred pre-confirm pump.fun deploy feed from MadeOnSol — new token launches surfaced ~500ms before on-chain confirmation, from elite/good tier deployers. PRO/ULTRA.",
