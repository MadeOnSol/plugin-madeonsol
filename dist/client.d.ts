...
export declare class MadeOnSolClient {
     ...
     */
    getDeployerHistory(wallet: string, limit?: number): Promise<{
        data?: DeployerHistory | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getDeployerAsOf(wallet: string, date?: string): Promise<{
        data?: DeployerAsOf | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getDeployerRewards(wallet: string): Promise<{
        data?: DeployerRewards | undefined;
        error?: string;
        status: number;
    }>;
     ...
     */
    getWalletHoldings(address: string, params?: {
        limit?: number;
     ...
     */
    getTokenPools(mint: string): Promise<{
        data?: TokenPools | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenDepth(mint: string, params?: {
        sizes?: number[];
    }): Promise<{
     ...
     */
    getTokenLocks(mint: string, params?: TokenLocksParams): Promise<{
        data?: TokenLocks | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenLocksFeed(params?: TokenLocksFeedParams): Promise<{
        data?: TokenLocksFeed | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenUnlocks(params?: TokenUnlocksParams): Promise<{
        data?: TokenUnlocks | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenFeeShares(mint: string): Promise<{
        data?: TokenFeeShares | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenFeeClaims(params?: TokenFeeClaimsParams): Promise<{
        data?: TokenFeeClaims | undefined;
        error?: string;
        status: number;
    }>;
    /**
     ...
     */
    getTokenSurges(params?: TokenSurgesParams): Promise<{
        data?: TokenSurges | undefined;
        error?: string;
        status: number;
    }>;
